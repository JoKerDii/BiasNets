...
class BSplineActivation(nn.Module):
    ...
    # Main Methods
        ...
        **reshape_forward**, **reshape_back**: make sure the shapes of input and output of the activation function are correct (2D or 3D or 4D tensor).
    ...
    def __init__(
        ...
        self.spline_range = 4  # TODO: should be a reasonable value, since it affects performance
        # a helper function
